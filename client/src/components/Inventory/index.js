      ...
      <React.Fragment>
        ...
        <div className='inventory-selector'>
          <div className='inventory-image-detail'>
            { selectedObject == null && equipedObject!=selectedObject  && <img className='selected-item-image' src={'./images/inventory/' + equipedObject.name + '.png'}/> } 
            { selectedObject != null && <img className='selected-item-image' src={'./images/inventory/' + selectedObject.name + '.png'}/> } 
